...
#SBATCH --array=0-10           # Job array -> differnt SLURM_ARRAY_TASK_ID
...
NUM_REPEAT=20
MATRIX_SIZE=$((250+${SLURM_ARRAY_TASK_ID}))

mkdir ${MATRIX_SIZE}
cd ${MATRIX_SIZE}

CC -DUSE_ALGOR=0 -O3 -o ./matmul.exe \
	-I../../../src ../../../src/matmul_main.cpp 
...
srun ./matmul_pat.exe ${NUM_REPEAT} ${MATRIX_SIZE} ${MATRIX_SIZE} ${MATRIX_SIZE}
